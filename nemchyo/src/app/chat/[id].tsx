...
const makeStyles = (theme: Colors) => StyleSheet.create({
  ...
  bubble: { borderRadius: 23, paddingHorizontal: 15, paddingVertical: 11, ...shadow.sm },
  bubbleMedia: { padding: 4, paddingBottom: 6 },
  mine: { backgroundColor: theme.primary, borderBottomRightRadius: 8 },
  theirs: { backgroundColor: theme.bubbleTheirs, borderBottomLeftRadius: 8 },
  ...
  edited: { fontSize: 10, color: theme.textFaint },
  ...
  quoteText: { fontSize: 12, color: theme.textMuted },
